...
function Popup() {
  ...
  const showAlert = () =>{
     setbuttonContent('Your Learning style is reading')
  }
  ...
  return (
    <>
      <Button variant="btn btn-secondary" onClick={handleShow}>
           {buttonContent==""?"Take Survey":"Your Learning style is reading"}
      </Button>

      <Modal  show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title>Answer the most relevant one according to you</Modal.Title>
        </Modal.Header>
        <Modal.Body style={{ width: "150vh" }}><div className="survey-form-pop-up">
